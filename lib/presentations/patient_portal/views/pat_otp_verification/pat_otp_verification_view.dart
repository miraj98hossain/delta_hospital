...
class PatOtpVerificationView extends StatefulWidget {
  const PatOtpVerificationView({super.key});

  @override
  State<PatOtpVerificationView> createState() => _PatOtpVerificationViewState();
}

class _PatOtpVerificationViewState extends State<PatOtpVerificationView> {
  @override
