...
import 'package:delta_hospital/presentations/book_appointment/data/data_sources/book_apt_remote_data_source.dart';
import 'package:delta_hospital/presentations/book_appointment/domain/repositories/book_apt_repository.dart';
import 'package:delta_hospital/presentations/doctor_portal/domain/repositories/doc_portal_repository.dart';
import 'package:delta_hospital/presentations/hn_registration/data/data_sources/hn_reg_remote_data_source.dart';
import 'package:delta_hospital/presentations/hn_registration/data/repositories/hn_reg_repository_impl.dart';
import 'package:delta_hospital/presentations/hn_registration/domain/repositories/hn_reg_repository.dart';
import 'package:delta_hospital/presentations/items_booking/data/data_sources/items_booking_remote_data_source.dart';
import 'package:delta_hospital/presentations/items_booking/data/repositories/items_booking_repository_impl.dart';
import 'package:delta_hospital/presentations/management/data/data_sources/mng_portal_remote_data_source.dart';
import 'package:delta_hospital/presentations/management/data/repositories/mng_portal_repository_impl.dart';
import 'package:delta_hospital/presentations/management/domain/repositories/mng_portal_repository.dart';
import 'package:delta_hospital/presentations/patient_portal/data/data_sources/pat_portal_remote_data_source.dart';
import 'package:delta_hospital/presentations/patient_portal/data/repositories/pat_portal_repository_impl.dart';
import 'package:delta_hospital/presentations/patient_portal/domain/repositories/pat_portal_repository.dart';
import 'package:get_it/get_it.dart';

import '../presentations/book_appointment/data/repositories/book_apt_repository_impl.dart';
import '../presentations/doctor_portal/data/data_sources/doc_portal_remote_data_source.dart';
import '../presentations/doctor_portal/data/repositories/doc_portal_repository_impl.dart';
import '../presentations/items_booking/domain/repositories/items_booking_repository.dart';
