...
class DoctorConsultationGridListResponse {
  final bool? success;
  final bool? info;
  final bool? warning;
  ...
  final dynamic model;
  final dynamic items;
  final ConsultationGridList? obj;
  final dynamic count;

  DoctorConsultationGridListResponse({
    this.success,
    this.info,
    this.warning,
    this.message,
  ...
  DoctorConsultationGridListResponse copyWith({
    bool? success,
    bool? info,
    bool? warning,
    String? message,
  ...
  factory DoctorConsultationGridListResponse.fromJson(String str) =>
      DoctorConsultationGridListResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory DoctorConsultationGridListResponse.fromMap(
      ...
      DoctorConsultationGridListResponse(
        ...
        obj: json["obj"] == null
            ? null
            : ConsultationGridList.fromMap(json["obj"]),
        count: json["count"],
      );
...
class ConsultationGridList {
  ...
  factory ConsultationGridList.fromJson(String str) =>
      ConsultationGridList.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ConsultationGridList.fromMap(Map<String, dynamic> json) =>
      ConsultationGridList(
        draw: json["draw"],
        ...
        data: json["data"] == null
            ...
            : List<Consultation>.from(
                json["data"]!.map((x) => Consultation.fromMap(x))),
      );
...
class Consultation {
  ...
  Consultation copyWith({
    ...
    int? consultationConfirmTime,
    int? prescriptionNo,
    int? prescriptionDateTime,
    int? isPatientIn,
    int? isPatientOut,
    String? isFeesPaid,
    int? patTypeNo,
  ...
  factory Consultation.fromJson(String str) =>
      Consultation.fromMap(json.decode(str));
