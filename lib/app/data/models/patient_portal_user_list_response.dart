...
class PatientPortalListResponse {
  ...
  factory PatientPortalListResponse.fromJson(String str) =>
      PatientPortalListResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PatientPortalListResponse.fromMap(Map<String, dynamic> json) =>
      PatientPortalListResponse(
        ...
        items: json["items"] == null
            ? []
            : List<PatientPortalUser>.from(
                json["items"]!.map((x) => PatientPortalUser.fromMap(x))),
        obj: json["obj"],
        count: json["count"],
      );
...
class PatientPortalUser {
  ...
  factory PatientPortalUser.fromJson(String str) =>
      PatientPortalUser.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PatientPortalUser.fromMap(Map<String, dynamic> json) =>
      PatientPortalUser(
